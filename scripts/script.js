...
function submitMovieBtn() {
    ...
    if (
        movieTitle.reportValidity() &&
        movieGenre.reportValidity() &&
        movieLength.reportValidity() &&
        currTime.reportValidity()
    ) {
...
function submitSeriesBtn() {
    ...
    if (
        ...
        seriesGenre.reportValidity() &&
        totalSeasons.reportValidity() &&
        finishedSeasons.reportValidity() &&
